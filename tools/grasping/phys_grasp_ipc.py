...
masses = {
    'bar_clamp': 18.5, 'book': 34.8, 'bowl': 15.7, 'cat': 9.9, 'cube_3cm': 3.0,'cube': 3.0 ,'cuboid_try': 2.0, 'net': 20.0, 'cuboid2': 1.5,'endstop_holder': 16.3,
    'engine_part': 28.6, 'fan_extruder': 7.4, 'gearbox': 7.4, 'large_marker': 3.2, 'mount1': 10.4,
    'mug': 20.2, 'nozzle': 6.3, 'part1': 6.8, 'part3': 13.6, 'pawn': 18.6, 'pear': 6.5, 'pipe_connector': 40.5,
    'cylinder': 23.5,
    'sphere': 11.2, 'sulfur_neutron': 7.0, 'vase': 13.1, 'yoda': 20.4
    }
...
def get_ipc_input(obj_name, tf_lst, output_basedir, duration, step, E, contact_mu, args):
    ...
    with open(config, 'w') as f:
        ...
        temp_vol= obj.volume if obj.volume >0 else -obj.volume
